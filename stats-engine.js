/**
 * Market Research Statistics Toolkit — Stats Engine
 * Ported from SurveyLens (TypeScript) to vanilla JavaScript
 *
 * Dependency: jStat (load via CDN before this script)
 *   <script src="https://cdn.jsdelivr.net/npm/jstat@latest/dist/jstat.min.js"></script>
 *
 * Usage: window.StatsEngine.ttest(a, b), etc.
 */
...
(function () {
  ...
  window.StatsEngine = {
    ...
    // Robust ANOVA
    welchAnova: welchAnova,

    // Repeated Measures & Advanced
    friedman: friedman,
    ...
    sentiment: sentiment,
    postStratWeighting: postStratWeighting,
    propensityScoreMatching: propensityScoreMatching,
    ...
    latentClassAnalysis: latentClassAnalysis,

    // Advanced Psychometrics & Multilevel
    cfa: cfa,
    irt: irt,
    mixedEffects: mixedEffects,
